...
namespace AdvancedApp.Migrations
{
    ...
    [Migration("20220817125056_ReSeme")]
    partial class ReSeme
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence<int>("ReSe")
                .StartsAt(100L)
                .IncrementsBy(3);
            ...
            modelBuilder.Entity("AdvancedApp.Models.Employee", b =>
                {
                    ...
                    b.Property<string>("GeneratedValueT")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValueSql("'REFERENCE_' + CONVERT(varchar, NEXT VALUE FOR ReSe)");
